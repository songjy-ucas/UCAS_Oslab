...
#define SYSCALL_NET_RECV_STREAM 83
#define SYSCALL_NET_RESET 84
#define SYSCALL_SET_SCHE_WORKLOAD 80
#define SYSCALL_WRITECH 81
#define SYSCALL_TASKSET 82
